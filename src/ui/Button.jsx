...
export const Button = ({ children, disabled, to, type, onClick }) => {
  const base =
    "sm:px-6 sm:py-2 text-sm bg-yellow-400 uppercase tracking-wide rounded-full font-semibold text-stone-800 inline-block  hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:bg-yellow-300 focus:ring-offset-2";
  const styles = {
